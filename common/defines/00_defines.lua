...
NGame = {
	...
	LAG_DAYS_FOR_PAUSE = 200,						-- Days of client lag for pause of gamespeed.
	GAME_SPEED_SECONDS = { 2.0, 0.5, 0.2, 0.04, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
	...
	AIR_LOG_TIMEOUT_HOURS = 2,						-- Data storring data
...
NDiplomacy = {
	...
	BASE_TRUCE_PERIOD = 100,							-- Base truce period in days.
	...
	BASE_SEND_ATTACHE_CP_COST = 25.0,				-- Command Power sent attache usage cost
	...
	GUARANTEE_COST = 999,							-- Scale with the number of already guaranteed countries.
	REVOKE_GUARANTEE_COST = 999,
	...
	AUTONOMY_LEVEL_CHANGE_PP_ANNEX = 999,			-- Annexation cost
	AUTONOMY_LEVEL_CHANGE_PP_FREE = 999,			-- Break free cost
	...
	ASSUME_FACTION_LEADERSHIP_PP_COST = 100,				-- Political power cost to assume faction leadership
...
NCountry = {
	...
	VP_TO_SUPPLY_BASE = 10,							-- Bonus to supply from a VP, no matter the level
	...
	RESISTANCE_STRENGTH_FROM_VP = 0.000,			-- How much strength ticking speed gives each VP score.
	RESISTANCE_STRENGTH_FROM_NEIGHBORS = 0, 		-- Multiplies how much resistance can spread from one state to its neighbors, a state will spread whatever is highest of its victorypoints resistance increase or half of any of its neighbors spread, multiplied by this
	RESISTANCE_DECAY_WHEN_NO_GROWTH = 10,		-- Resistance will fall by this much each day if there is nothing increasing it ( no VPs and no spread from neighbors )
	...
	REINFORCEMENT_EQUIPMENT_DELIVERY_SPEED = 1.2,	-- Modifier for army equipment reinforcement speed
	REINFORCEMENT_MANPOWER_DELIVERY_SPEED = 80.0,	-- Modifier for army manpower reinforcement delivery speed (travel time)
	REINFORCEMENT_MANPOWER_CHUNK = 0.08,				-- Chunk size of manpower reinforcement delivery, in % of total manpower needed by the template.
	...
	BOMBING_WAR_SUPPORT_PENALTY_SCALE = 0, 			-- Scaling of bomber damage to war support impact, will be added weekly as a war support penalty
	MAX_BOMBING_WEEKLY_WAR_SUPPORT_PENALTY = 0,			-- Max penalty that will gained per week from bomber's damage
	BOMBING_WEEKLY_WAR_SUPPORT_PENALTY_DECAY = 0,		-- Weekly decay of bomber damage war support penalty
	MAX_BOMBING_WAR_SUPPORT_IMPACT = 0,					-- Max total penalty from bomber's damage
	...
	CONVOYS_BEING_RAIDED_WAR_SUPPORT_PENALTY_SCALE = 0,			-- Scaling of trade convoy raided to war support impact, will be added weekly as a war support penalty
	MAX_CONVOYS_BEING_RAIDED_WEEKLY_WAR_SUPPORT_PENALTY = 0,	-- Max penalty that will gained per week from trade convoy raided
	CONVOYS_BEING_RAIDED_WEEKLY_WAR_SUPPORT_PENALTY_DECAY = 0,	-- Weekly decay of trade convoy raided war support penalty
	MAX_CONVOYS_BEING_RAIDED_WAR_SUPPORT_IMPACT = 0,				-- Max total penalty from trade convoy raided
	...
	CONVOYS_SUNK_MULTIPLIER_FOR_WAR_SUPPORT = 0,	-- once a trade convoy ship sunk, you will get a larger negative impact on your war support
	CONVOYS_BEING_RAIDED_DAILY_WAR_SUPPORT_IMPACT_FROM_OVERSEA_STATES = 0,	-- resource transfer convoys convoys from our states being raided will give a daily war support penalty depending on how important that resource is and how inefficent convoys are
	CONVOYS_SUNK_MULTIPLIER_FOR_WAR_SUPPORT_FROM_OVERSEA_STATES = 0,			-- once a resource transfer convoys from our states ship sunk, you will get a larger negative impact on your war support
	CONVOYS_BEING_RAIDED_DAILY_WAR_SUPPORT_IMPACT = 0,	-- trade convoys being raided will give a daily war support penalty depending on how important that resource is and how inefficent convoys are
	...
	PROPAGANDA_STABILITY_DAILY_DECAY = 0,		-- Amount of stability recovered daily from propaganda effort
	PROPAGANDA_WAR_SUPPORT_DAILY_DECAY = 0,		-- Amount of war support recovered daily from war support effort
	...
	GIE_DIVISION_ATTACK_BONUS_AGAINST_OCCUPIER = 0, -- Attack bonus factor against whoever occupies your core territory.
	GIE_DIVISION_DEFENSE_BONUS_AGAINST_OCCUPIER = 0, -- Attack bonus factor against whoever occupies your core territory.
	GIE_DIVISION_ATTACK_BONUS_ON_CORE = 0, -- Attack bonus factor when fighting on cores.
	GIE_DIVISION_DEFENSE_BONUS_ON_CORE = 0, -- Defense bonus factor when fighting on cores.
...
NResistance = {
	...
	RESISTANCE_TARGET_MODIFIER_HAS_CLAIM = -100.0,			-- resistance target modifier in % for states we have claim
	...
	RESISTANCE_TARGET_MODIFIER_IS_AT_PEACE = -100.0,			-- resistance target modifier when we are at peace
	...
	RESISTANCE_GROWTH_MAX = 10.0, -- max resistance grow
	
	COMPLIANCE_GROWTH_BASE = 75, -- base compliance grow
	COMPLIANCE_GROWTH_MIN = -100.0, -- min compliance grow
	COMPLIANCE_GROWTH_MAX = 100.0, -- max compliance grow
	
	COMPLIANCE_GROWTH_IS_AT_PEACE = 100, -- compliance growth buff at peace
	COMPLIANCE_GROWTH_HAS_CLAIM = 100, -- compliance growth buff if state has a claim
...
NProduction = {
	...
	CAPITAL_SHIP_MAX_NAV_FACTORIES_PER_LINE = 50,
...
NPolitics = {
	BASE_LEADER_TRAITS = 4,				-- Base amount of leader traits.
...
NBuildings = {
	ANTI_AIR_SUPERIORITY_MULT = 3.0,	-- How much air superiority reduction to the enemy does our AA guns? Normally each building level = -1 reduction. With this multiplier.
	MAX_BUILDING_LEVELS = 100,			-- Max levels a building can have.
	...
	MAX_SHARED_SLOTS = 120,				-- Max slots shared by factories
...
NDeployment = {
	BASE_DEPLOYMENT_TRAINING = 3,		-- Base training done each day during deployment.
},
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 999,			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 999,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	FIELD_MARSHAL_ARMIES_CAP = 999,				-- how many armies a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	ARMY_LEADER_XP_GAIN_PER_UNIT_IN_COMBAT = 0, -- XP gain per unit in combat
	...
	BASE_LEADER_TRAIT_GAIN_XP = 0,			   -- Base xp gain for traits per hour for armies
	...
	ANTI_AIR_TARGETTING_TO_CHANCE = 0.00875,			-- Balancing value to determine the chance of ground AA hitting an attacking airplane, affecting both the effective average damage done by AA to airplanes, and the reduction of damage done by airplanes due to AA support
	ANTI_AIR_ATTACK_TO_AMOUNT = 0,				-- Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit.
	...
	SLOWEST_SPEED = 4,
	REINFORCEMENT_REQUEST_MAX_WAITING_DAYS = 20,   -- Every X days the equipment will be sent, regardless if still didn't produced all that has been requested.
	REINFORCEMENT_REQUEST_DAYS_FREQUENCY = 10,	   -- How many days must pass until we may give another reinforcement request
	EXPERIENCE_COMBAT_FACTOR = 0.13,
	...
	AIR_SUPPORT_BASE = 0.40,                        -- CAS bonus factor for air support moddifier for land unit in combat
	...
	REINFORCE_CHANCE = 0.0,                 	   -- base chance to join combat from back line when empty
	...
	PLANNING_DECAY = 0.02,
	PLAYER_ORDER_PLANNING_DECAY = 0.015,				-- Amount of planning lost due to player manual order
	PLANNING_GAIN = 0.05,
	...
	BATALION_CHANGED_EXPERIENCE_DROP = 0,			-- Division experience drop if unit has different batalion
	...
	ARMY_INITIATIVE_REINFORCE_FACTOR = 0.5,		-- scales initiative for reinforce chance
	
	BASE_CAPTURE_EQUIPMENT_RATIO = 0.3,				-- after a successful land combat, ratio of the equipments that are being captured/salvaged from enemy's lost equipment

	ACCLIMATIZATION_IN_COMBAT_SPEED_FACTOR = 2,		-- Acclimatization speed multiplier while being in combat.
	ACCLIMATIZATION_SPEED_GAIN = 0.10,				-- A variable used to balance the overall speed of gaining the acclimatization
	...
	PROMOTE_LEADER_CP_COST = 0,					-- cost of promoting a leader
	
	FIELD_MARSHAL_ARMY_BONUS_RATIO = 0.5,           -- ratio to apply regular bonuses FM bonuses to armies
	
	FIELD_MARSHAL_XP_RATIO = 0,					-- xp gain ratio for army group leaders
	...
	UNIT_LEADER_ASSIGN_TRAIT_COST = 0.0,					-- cost to assign a new trait to a unit leader
	ATTACHED_WINGS_ORDER_UPDATE_DAYS = 5,					-- Days untill the attached wing will update the order
	
	BORDER_WAR_WIN_DAYS_AGAINST_EMPTY_OPPONENTS = 1,		-- border wars will be automatically won if no opponent shows up for this duration
	...
	ARMY_FUEL_COST_MULT = 0.2,						-- fuel cost multiplier for all army related stuff
...
NAir = {
	AIR_WING_FLIGHT_SPEED_MULT = 1,					-- Global speed multiplier for airplanes (affects fe.transferring to another base)
	...
	COMBAT_DAMAGE_SCALE = 0.03,							-- Higher value = more shot down planes
	...
	ACE_DEATH_CHANCE_BASE = 0.0,						-- Base chance % for ace pilot die when an airplane is shot down in the Ace wing.
	...
	ACE_WING_SIZE_MAX_BONUS = 1,                       -- biggest bonus we can get from having a small wing with an ace on
	...
	ANTI_AIR_ATTACK_TO_DAMAGE_REDUCTION_FACTOR = 0.5,	-- Balancing value to convert equipment stat anti_air_attack to the damage reduction modifier apply to incoming air attacks against units with AA.
	...
	AIR_DEPLOYMENT_DAYS = 0.0001,							-- Days to deploy one air wing
	...
	AIR_MORE_GROUND_CREWS_COST = 400.0,					-- CP cost to maintain more ground crews
	...
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_CAS = 0.111,				-- How much efficiency to regain per day. Gain applied hourly.
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_NAVAL_BOMBER = 0.111,		-- How much efficiency to regain per day. Gain applied hourly.
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_TACTICAL_BOMBER = 0.0096,	-- How much efficiency to regain per day. Gain applied hourly.
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_FIGHTER = 0.111,			-- How much efficiency to regain per day. Gain applied hourly.
	...
	AIR_WING_XP_TRAINING_MAX = 30.0, 									--Max average XP achieved with training.
	
	AIR_WING_XP_TRAINING_MISSION_GAIN_DAILY = 13.3, 						--Daily gain when running training exercise mission
	AIR_WING_XP_AIR_VS_AIR_COMBAT_GAIN = 0.9, 							--Wings in combat gain extra XP	
	AIR_WING_XP_GROUND_MISSION_COMPLETED_GAIN = 0.48, 					--Bombers bombing, CAS cassing, NBs nbing, kamikazees kamikazeeing, etc.	
	AIR_WING_XP_RECON_MISSION_COMPLETED_GAIN = 0.45, 					--recon mission

	AIR_WING_COUNTRY_XP_FROM_TRAINING_FACTOR = 0.5, 					--Factor on country Air XP gained from wing training
	...
	DISRUPTION_FACTOR = 3.0,									-- multiplier on disruption damage to scale its effects on planes
...
NNavy = {
	...
	NAVAL_MINES_IN_REGION_MAX = 1,								-- Max number of mines that can be layed by the ships. The value should be hidden from the user, as we present % so it's an abstract value that should be used for balancing.
	...
	NAVAL_COMBAT_AIR_CAPITAL_TARGET_SCORE = 100,
...
NOperatives = {
	AGENCY_CREATION_DAYS = 999,						-- Number of days needed to create an intelligence agency
	AGENCY_UPGRADE_DAYS = 90,						-- Number of days needed to upgrade an intelligence agency
	AGENCY_CREATION_FACTORIES = 999,					-- Number of factories used to create an intelligence agency
	...
	BECOME_SPYMASTER_MIN_UPGRADES = 0,				-- Number of agency upgrades you need before becoming Spy Master
	...
	OPERATIVE_BASE_CONTROL_TRADE_DRIFT = 0.0,				-- The base daily drift in trade influence caused by an operative
	CONTROL_TRADE_STACKING_FACTOR = 0.0,					-- Multiplied to the drift of each operative after the first one
	CONTROL_TRADE_MAX_INFLUENCE = 0.0,					-- The maximum amount of trade influence that can be gained through the control trade mission
...
NIntel = {
	...
	ARMY_INTEL_COMBAT_BONUS_MAX_BONUS = 0.05, -- max combat bonus that will apply when intel is high enough
