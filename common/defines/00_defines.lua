...
NMilitary = {
	...
	AIR_SUPPORT_BASE = 0.30,                        -- CAS bonus factor for air support moddifier for land unit in combat
...
NAir = {
	...
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_FIGHTER = 0.360,			-- How much efficiency to regain per day. Gain applied hourly.
...
NNavy = {
	...
	AA_EFFICIENCY_PENALTY_ON_MINIMUM_POSITIONING					= 0.9,  -- AA penalty at 0% positioning
...
NAI = {
	...
	VARIANT_UPGRADE_MIN_XP = 25,				-- Minimum XP before attempting to create a new variant.
