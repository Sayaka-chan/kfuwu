...
NDefines.NNavy.ACCIDENTS_CHANCE_BALANCE_FACTOR = 0							-- General chance for naval accidents for balancing the gameplay.
...
NDefines.NNavy.CARRIER_STACK_PENALTY = 6 -- The most efficient is 5 carriers in combat. 6+ brings the penalty to the amount of wings in battle.
...
NDefines.NNavy.SUBMARINE_REVEALED_TIMEOUT = 30		-- Amount of in-game-hours that makes the submarine visible if it is on the defender side.
...
NDefines.NNavy.NAVAL_COMBAT_AIR_LOW_AA_TARGET_SCORE = 25                           -- how much score factor from low AA guns (scales between 0->this number)
